...
//		히라가나 Textfield
		...
		add_Hiragana.setFont(new Font("a옛날사진관3", Font.PLAIN, 23));
...
//		뜻 Textfield
		...
		add_Meaning.setFont(new Font("a옛날사진관3", Font.PLAIN, 23));
...
//		확인 버튼
		...
		input_Ok.setFont(new Font("a옛날사진관3", Font.PLAIN, 30));
		input_Ok.setBounds(60, 158, 143, 59);
		contentPane.add(input_Ok);
		
		JButton input_Cancel = new JButton("취소");
		input_Cancel.setFont(new Font("a옛날사진관3", Font.PLAIN, 30));
